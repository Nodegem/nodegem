...
//        {
//            await _terminal.DebugLogAsync(user, "Building nodes...", macro.IsDebugModeEnabled);
//            var nodes = await macro.Nodes.ToNodeDictionaryAsync(_provider, this, user);
//            
//            await _terminal.DebugLogAsync(user, "Building fields...", macro.IsDebugModeEnabled);
...
//            });
//            
//            await _terminal.DebugLogAsync(user, "Establishing connections between fields...", macro.IsDebugModeEnabled);
...
//
//            await _terminal.DebugLogAsync(user, "Macro successfully built!", macro.IsDebugModeEnabled);
//            return builtMacro;
//        }
//
